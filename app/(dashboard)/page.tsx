        ...
        <div className="container mx-auto p-8 max-w-7xl animate-in fade-in duration-500">
            <div className="flex flex-col gap-8">
                <div>
                    ...
                    <p className="text-slate-400">Welcome back to KLI Hub Intelligence.</p>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <Card className="bg-slate-900 border-slate-800">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium text-slate-200">RAG Status</CardTitle>
                            <Database className="h-4 w-4 text-amber-500" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold text-amber-500">Pending</div>
                            <p className="text-xs text-slate-500">Waiting for n8n connection</p>
                        </CardContent>
                    </Card>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    <Link href="/intelligence">
                        <Card className="bg-slate-900 border-slate-800 hover:bg-slate-800/50 transition-colors cursor-pointer group h-full">
                            <CardHeader>
